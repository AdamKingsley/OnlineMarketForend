<template>
  <div class="box">
    <div class="nav">
      ...
      <ul class="detail" style="margin-right:8%">
        ...
        <li>
          <router-link
            v-show="userInfo.type != 'ADMIN'"
            v-bind:to="userInfo.type === 'MERCHANT' ? '/merchant' : '/'"
            >网站导航</router-link
          >
        </li>
        <!-- <li>
          <router-link v-show="userInfo.type != 'ADMIN'" to="/freeback"
            >意见反馈</router-link
          >
        </li> -->
        <li>
          <router-link v-show="userInfo.type != 'ADMIN'" to="/"
            >商城首页</router-link
          >
          <!-- <router-link
            v-show="userInfo.type != 'ADMIN'"
            :to="{ path: '/merchant', name: 'Merchant', query: { id: 1 } }"
          >
            进个店铺
          </router-link> -->
        </li>
