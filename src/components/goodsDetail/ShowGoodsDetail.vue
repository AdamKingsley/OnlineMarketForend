<template>
  <div>
    <div class="item-intro-show">
      <div class="item-intro-detail" ref="itemIntroDetail" style="height:200px">
        <div class="item-intro-nav item-tabs">
          <Tabs @on-click="changeHeight">
            <TabPane label="商品介绍">
...
export default {
  ...
  created () {
    // this.changeHeight(0);
    // this.$refs.itemIntroDetail.style.height = '200px';
  },
  computed: {
    ...mapState(['goodsInfo'])
  },
  methods: {
    changeHeight (tabIndex) {
      ...
      if (tabIndex === 0) {
        ...
        this.$refs.itemIntroDetail.style.height = '600px';
      }
      // let heightCss = window.getComputedStyle(this.$refs.itemIntroDetail).heigh;
      // console.log(heightCss);
      // heightCss = parseInt(heightCss.substr(0, heightCss.length - 2)) + 600;
